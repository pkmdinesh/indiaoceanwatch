...
const I18N_DICTIONARY = {
  en: {
    ...
    'osf.title': 'Ocean State Forecast (OSF)',
    ...
    'dsle.title': 'Dynamic Sea-Level Envelope (DSLE)',
    'dsle.overtopping': 'Overtopping risk (Crest + Hs):',
    'dsle.grounding': 'Grounding risk (Trough - Hs/2):',
    ...
    'climate.kicker': 'Ocean Climate & Ecology Monitoring',
    ...
    'other.tuna': 'Tuna ↗',
    'other.hilsa': 'Hilsa ↗',
    'other.hab': 'Harmful Algal Bloom (ABIS)',
    ...
    'abis.title': '🌿 Algal Bloom Information Services (ABIS)',
    'abis.subtitle': 'INCOIS · Detection & Monitoring of Bloom in the Indian Seas',
    'abis.live_bulletin': 'Latest Bloom Information',
    'abis.latest_run': 'Last Updated:',
    'abis.overview': 'INCOIS Algal Bloom Information Services (ABIS) provides near real-time spatio-temporal detection and spread monitoring of phytoplankton blooms over the North Indian Ocean (0°–31°N & 35°E–103°E) to safeguard fisheries, mariculture, and marine ecosystems.',
    'abis.normal': 'Normal',
    'abis.normal_sub': 'Bloom Pixels < 50%',
    'abis.watch': 'Watch',
    'abis.watch_sub': 'Bloom Pixels 50% – 75%',
    'abis.warning': 'Warning',
    'abis.warning_sub': 'Bloom Pixels > 75%',
    'abis.nodata': 'No Sufficient Data',
    'abis.nodata_sub': 'Cloud / Satellite Gap',
    'abis.hotspots_title': '📍 Identified Ecological Bloom Hotspots',
    'abis.hotspot_a_title': 'a) North Eastern Arabian Sea (NEAS)',
    'abis.hotspot_a_desc': 'Characterized by seasonal winter-spring green Noctiluca scintillans blooms, high chlorophyll anomalies, and associated subsurface hypoxia.',
    'abis.hotspot_b_title': 'b) Coastal Waters of Kerala (KRL)',
    'abis.hotspot_b_desc': 'Monsoon coastal upwelling zone susceptible to mixed diatom blooms, red Noctiluca, and localized fish asphyxia.',
    'abis.hotspot_c_title': 'c) Gulf of Mannar (GOM)',
    'abis.hotspot_c_desc': 'Ecologically sensitive biosphere reserve monitoring coral reef health, mariculture habitats, and micro-plankton surges.',
    'abis.hotspot_d_title': 'd) Coastal Waters of Gopalpur (GPLPR)',
    'abis.hotspot_d_desc': 'North-Western Bay of Bengal coastal region tracking riverine nutrient discharge, diatom blooms, and pelagic fishery complement.',
    'abis.live_products': '📊 Live Bloom Products ↗',
    'abis.map_viewer': '🗺️ Large Map Viewer ↗',
    'osf.svas_title': 'Small Vessel Advisory Service (SVAS)',
    'osf.svas_kind': 'Boat Safety Index (BSI)',
    'svas.boat_size': 'Boat Category / Width',
    'svas.day': 'Day',
    'svas.day1': 'Day-1',
    'svas.day2': 'Day-2',
    'svas.day3': 'Day-3',
    'svas.small_craft': 'Small (< 4m)',
    'svas.small_craft_desc': 'Traditional, Vallam, Catamaran, Dol Net',
    'svas.medium_craft': 'Medium (< 6m)',
    'svas.medium_craft_desc': 'Gill Netter, Ring Seine, Hook & Line',
    'svas.large_craft': 'Large (< 7m)',
    'svas.large_craft_desc': 'Trawler, Purse Seiner',
    'svas.badge_alert': 'Alert',
    'svas.badge_safe': 'Safe',
    'svas.banner_alert_title': '⚠️ Sailing Restrictions in Effect',
    'svas.banner_alert_sub': 'Boats with width {sizes} should not venture out into restricted coastal sectors.',
    'svas.banner_safe_title': '✅ Safe for All Small Vessel Categories',
    'svas.banner_safe_sub': 'Favorable sea conditions predicted across the 3-day forecast window.',
    'svas.safety_guidance': 'Navigational Safety Advisory:',
    'svas.guidance_unsafe': 'Restricted',
    'svas.guidance_safe': 'Permitted',
    'svas.near_me': 'Near Me',
    'svas.locating': 'Locating…',
    'svas.gps_failed': 'Unable to retrieve location.',
    'svas.gps_unsupported': 'Geolocation is not supported by your browser.',
    'svas.coastal_waters': 'coastal waters',
    ...
    'footer.google_search': 'Google: India Ocean Watch ↗',
    'share.google': 'Google Search ↗',
  ...
  hi: {
    ...
    'osf.title': 'महासागर राज्य पूर्वानुमान (OSF)',
    ...
    'dsle.title': 'डायनेमिक सी-लेवल एन्वेलप (DSLE)',
    'dsle.overtopping': 'ओवरटॉपिंग जोखिम (Crest + Hs):',
    'dsle.grounding': 'ग्राउंडिंग जोखिम (Trough - Hs/2):',
    ...
    'climate.kicker': 'महासागरीय जलवायु एवं पारिस्थितिकी निगरानी',
    ...
    'abis.title': '🌿 शैवाल प्रस्फुटन सूचना सेवा (ABIS)',
    'abis.subtitle': 'INCOIS · भारतीय समुद्रों में शैवाल प्रस्फुटन की पहचान एवं निगरानी',
    'abis.live_bulletin': 'नवीनतम प्रस्फुटन जानकारी',
    'abis.latest_run': 'अंतिम अद्यतन:',
    'abis.overview': 'INCOIS शैवाल प्रस्फुटन सूचना सेवा (ABIS) मत्स्य पालन, समुद्री कृषि और समुद्री पारिस्थितिकी तंत्र की सुरक्षा के लिए उत्तरी हिंद महासागर (0°–31°N और 35°E–103°E) पर पादप प्लवक के प्रस्फुटन की वास्तविक समय पहचान एवं प्रसार निगरानी प्रदान करती है।',
    'abis.normal': 'सामान्य',
    'abis.normal_sub': 'प्रस्फुटन पिक्सल < 50%',
    'abis.watch': 'निगरानी (Watch)',
    'abis.watch_sub': 'प्रस्फुटन पिक्सल 50% – 75%',
    'abis.warning': 'चेतावनी (Warning)',
    'abis.warning_sub': 'प्रस्फुटन पिक्सल > 75%',
    'abis.nodata': 'पर्याप्त डेटा नहीं',
    'abis.nodata_sub': 'बादल / उपग्रह अंतर',
    'abis.hotspots_title': '📍 पहचाने गए पारिस्थितिक प्रस्फुटन हॉटस्पॉट',
    'abis.hotspot_a_title': 'a) उत्तर पूर्वी अरब सागर (NEAS)',
    'abis.hotspot_a_desc': 'मौसमी शीत-वसंत हरी नोक्टिलुका सिंटिलान्स प्रस्फुटन, उच्च क्लोरोफिल विसंगतियों और सबसर्फेस हाइपोक्सिया द्वारा लक्षित।',
    'abis.hotspot_b_title': 'b) केरल के तटीय जल (KRL)',
    'abis.hotspot_b_desc': 'मानसूनी तटीय अपवेलिंग क्षेत्र जो डायटम प्रस्फुटन, लाल नोक्टिलुका और स्थानीय मछली श्वासावरोध के प्रति संवेदनशील है।',
    'abis.hotspot_c_title': 'c) मन्नार की खाड़ी (GOM)',
    'abis.hotspot_c_desc': 'पारिस्थितिक रूप से संवेदनशील बायोस्फीयर रिजर्व जो प्रवाल भित्ति स्वास्थ्य, समुद्री संवर्धन और सूक्ष्म-प्लवक वृद्धि की निगरानी करता है।',
    'abis.hotspot_d_title': 'd) गोपालपुर के तटीय जल (GPLPR)',
    'abis.hotspot_d_desc': 'उत्तर-पश्चिमी बंगाल की खाड़ी का तटीय क्षेत्र जो नदीय पोषक तत्वों के बहाव, डायटम प्रस्फुटन और पेलाजिक मत्स्य पालन की निगरानी करता है।',
    'abis.live_products': '📊 लाइव प्रस्फुटन उत्पाद ↗',
    'abis.map_viewer': '🗺️ बड़ा मानचित्र दर्शक ↗',
    'osf.svas_title': 'छोटे पोत सलाहकार सेवा (SVAS)',
    'osf.svas_kind': 'नाव सुरक्षा सूचकांक (BSI)',
    'svas.boat_size': 'नाव श्रेणी / चौड़ाई',
    'svas.day': 'दिन',
    'svas.day1': 'दिन-1',
    'svas.day2': 'दिन-2',
    'svas.day3': 'दिन-3',
    'svas.small_craft': 'छोटी (< 4m)',
    'svas.small_craft_desc': 'पारंपरिक, वल्लम, कटामरन, डोल नेट',
    'svas.medium_craft': 'मध्यम (< 6m)',
    'svas.medium_craft_desc': 'गिल नेटर, रिंग सीन, हुक और लाइन',
    'svas.large_craft': 'बड़ी (< 7m)',
    'svas.large_craft_desc': 'ट्रॉलर, पर्स सीनर',
    'svas.badge_alert': 'चेतावनी',
    'svas.badge_safe': 'सुरक्षित',
    'svas.banner_alert_title': '⚠️ नौकायन पर प्रतिबंध प्रभावी',
    'svas.banner_alert_sub': '{sizes} चौड़ाई वाली नावों को प्रतिबंधित तटीय क्षेत्रों में नहीं जाना चाहिए।',
    'svas.banner_safe_title': '✅ सभी छोटी नावों के लिए सुरक्षित',
    'svas.banner_safe_sub': '3-दिवसीय पूर्वानुमान अवधि में अनुकूल समुद्री स्थिति की संभावना।',
    'svas.safety_guidance': 'नौवहन सुरक्षा सलाह:',
    'svas.guidance_unsafe': 'प्रतिबंधित',
    'svas.guidance_safe': 'अनुमति',
    'svas.near_me': 'मेरे निकट',
    'svas.locating': 'खोज रहे हैं…',
    'svas.gps_failed': 'स्थान प्राप्त करने में असमर्थ।',
    'svas.gps_unsupported': 'आपके ब्राउज़र द्वारा जियोलोकेशन समर्थित नहीं है।',
    'svas.coastal_waters': 'तटीय जल',
  ...
  ta: {
    ...
    'osf.title': 'கடல் நிலை முன்னறிவிப்பு (OSF)',
    ...
    'dsle.title': 'டைனமிக் கடல் மட்ட உறை (DSLE)',
    'dsle.overtopping': 'கடல்நீர் புகும் அபாயம் (Crest + Hs):',
    'dsle.grounding': 'தரைதட்டும் அபாயம் (Trough - Hs/2):',
    ...
    'climate.kicker': 'பெருங்கடல் காலநிலை மற்றும் சூழலியல் கண்காணிப்பு',
    ...
    'other.hab': 'நச்சு பாசி பெருக்கம் (ABIS)',
    ...
    'abis.title': '🌿 பாசி பெருக்க தகவல் சேவைகள் (ABIS)',
    'abis.subtitle': 'INCOIS · இந்தியக் கடல்களில் பாசிப் பெருக்கம் கண்டறிதல் மற்றும் கண்காணிப்பு',
    'abis.live_bulletin': 'சமீபத்திய பாசி பெருக்க தகவல்',
    'abis.latest_run': 'கடைசியாக புதுப்பிக்கப்பட்டது:',
    'abis.overview': 'INCOIS பாசி பெருக்க தகவல் சேவைகள் (ABIS) மீன்வளம், கடல்வாழ் உயிரின வளர்ப்பு மற்றும் கடல் சூழலியலைப் பாதுகாக்க வட இந்தியப் பெருங்கடலில் (0°–31°N & 35°E–103°E) தாவர மிதவை நுண்ணுயிர் பாசி பெருக்கத்தை நிகழ்நேரத்தில் கண்டறிந்து கண்காணிக்கிறது.',
    'abis.normal': 'இயல்பு',
    'abis.normal_sub': 'பாசி பிக்சல்கள் < 50%',
    'abis.watch': 'கண்காணிப்பு (Watch)',
    'abis.watch_sub': 'பாசி பிக்சல்கள் 50% – 75%',
    'abis.warning': 'எச்சரிக்கை (Warning)',
    'abis.warning_sub': 'பாசி பிக்சல்கள் > 75%',
    'abis.nodata': 'போதுமான தரவு இல்லை',
    'abis.nodata_sub': 'மேகமூட்டம் / இடைவெளி',
    'abis.hotspots_title': '📍 அடையாளம் காணப்பட்ட சுற்றுச்சூழல் பாசி ஹாட்ஸ்பாட்கள்',
    'abis.hotspot_a_title': 'a) வடகிழக்கு அரபிக்கடல் (NEAS)',
    'abis.hotspot_a_desc': 'குளிர்கால-வசந்தகால பச்சை நாக்டிலூகா (Noctiluca) பாசி பெருக்கம், உயர் பச்சைய முரண்பாடுகள் மற்றும் ஆக்ஸிஜன் குறைபாடு கொண்டது.',
    'abis.hotspot_b_title': 'b) கேரள கடலோரப் பகுதிகள் (KRL)',
    'abis.hotspot_b_desc': 'பருவமழை கால கடல் நீர் மேல்நோக்கிய சுழற்சி, கலப்பு டயட்டம் பாசி, சிவப்பு நாக்டிலூகா மற்றும் மீன் மூச்சுத்திணறல் ஏற்படும் பகுதி.',
    'abis.hotspot_c_title': 'c) மன்னார் வளைகுடா (GOM)',
    'abis.hotspot_c_desc': 'பவளப்பாறை ஆரோக்கியம், கடல்வாழ் உயிரின வாழ்விடங்கள் மற்றும் நுண்ணுயிர் பெருக்கத்தைக் கண்காணிக்கும் சுற்றுச்சூழல் உயிர்க்கோளக் காப்பகம்.',
    'abis.hotspot_d_title': 'd) கோபால்பூர் கடலோரப் பகுதிகள் (GPLPR)',
    'abis.hotspot_d_desc': 'நதி ஊட்டச்சத்து வெளியேற்றம், டயட்டம் பாசி பெருக்கம் மற்றும் மீன்வள கண்காணிப்பு கொண்ட வடமேற்கு வங்காள விரிகுடா கடற்கரை.',
    'abis.live_products': '📊 நேரடி பாசி தயாரிப்புகள் ↗',
    'abis.map_viewer': '🗺️ பெரிய வரைபட காட்சி ↗',
    'osf.svas_title': 'சிறிய கப்பல் ஆலோசனை சேவை (SVAS)',
    'osf.svas_kind': 'படகு பாதுகாப்பு குறியீடு (BSI)',
    'svas.boat_size': 'படகு வகை / அகலம்',
    'svas.day': 'நாள்',
    'svas.day1': 'நாள்-1',
    'svas.day2': 'நாள்-2',
    'svas.day3': 'நாள்-3',
    'svas.small_craft': 'சிறியது (< 4m)',
    'svas.small_craft_desc': 'பாரம்பரிய படகுகள், வள்ளம், கட்டுமரம், டோல் வலை',
    'svas.medium_craft': 'நடுத்தரம் (< 6m)',
    'svas.medium_craft_desc': 'கில் நெட்டர், ரிங் சீன், தூண்டில் படகுகள்',
    'svas.large_craft': 'பெரியது (< 7m)',
    'svas.large_craft_desc': 'டிராலர், பர்ஸ் சீனர்',
    'svas.badge_alert': 'எச்சரிக்கை',
    'svas.badge_safe': 'பாதுகாப்பானது',
    'svas.banner_alert_title': '⚠️ கடலுக்குச் செல்ல கட்டுப்பாடுகள்',
    'svas.banner_alert_sub': '{sizes} அகலம் கொண்ட படகுகள் தடைசெய்யப்பட்ட கடல் பகுதிக்குள் செல்லக்கூடாது.',
    'svas.banner_safe_title': '✅ அனைத்து சிறிய படகுகளுக்கும் பாதுகாப்பானது',
    'svas.banner_safe_sub': '3 நாள் முன்னறிவிப்பு காலத்தில் சாதகமான கடல் நிலை கணிக்கப்பட்டுள்ளது.',
    'svas.safety_guidance': 'கடல்வழி பயண பாதுகாப்பு ஆலோசனை:',
    'svas.guidance_unsafe': 'தடைசெய்யப்பட்டது',
    'svas.guidance_safe': 'அனுமதிக்கப்பட்டது',
    'svas.near_me': 'அருகில்',
    'svas.locating': 'கண்டறிகிறது…',
    'svas.gps_failed': 'இருப்பிடத்தைப் பெற முடியவில்லை.',
    'svas.gps_unsupported': 'உலாவி இருப்பிடத்தை ஆதரிக்கவில்லை.',
    'svas.coastal_waters': 'கடலோரப் பகுதி',
  ...
  te: {
    ...
    'osf.title': 'సముద్ర స్థితి సూచన (OSF)',
    ...
    'dsle.title': 'డైనమిక్ సముద్ర మట్ట ఎన్వలప్ (DSLE)',
    'dsle.overtopping': 'నీరు ముంచెత్తే ప్రమాదం (Crest + Hs):',
    'dsle.grounding': 'గ్రౌండింగ్ ప్రమాదం (Trough - Hs/2):',
    ...
    'climate.kicker': 'సముద్ర వాతావరణం మరియు పర్యావరణ పర్యవేక్షణ',
    ...
    'other.tuna': 'ట్యూనా ↗',
    'other.hilsa': 'హిల్సా ↗',
    'other.hab': 'హానికర ఆల్గల్ బ్లూమ్ (ABIS)',
    ...
    'abis.title': '🌿 ఆల్గల్ బ్లూమ్ సమాచార సేవలు (ABIS)',
    'abis.subtitle': 'INCOIS · భారత సముద్రాలలో ఆల్గల్ బ్లూమ్ గుర్తింపు మరియు పర్యవేక్షణ',
    'abis.live_bulletin': 'తాజా బ్లూమ్ సమాచారం',
    'abis.latest_run': 'చివరిగా నవీకరించబడింది:',
    'abis.overview': 'INCOIS ఆల్గల్ బ్లూమ్ సమాచార సేవలు (ABIS) మత్స్య సంపద, సముద్ర సాగు మరియు సముద్ర పర్యావరణ వ్యవస్థలను రక్షించడానికి ఉత్తర హిందూ మహాసముద్రంలో (0°–31°N & 35°E–103°E) ఫైటోప్లాంక్టన్ బ్లూమ్‌లను నిజ సమయంలో గుర్తించి పర్యవేక్షిస్తుంది.',
    'abis.normal': 'సాధారణం',
    'abis.normal_sub': 'బ్లూమ్ పిక్సెల్స్ < 50%',
    'abis.watch': 'వాచ్ (Watch)',
    'abis.watch_sub': 'బ్లూమ్ పిక్సెల్స్ 50% – 75%',
    'abis.warning': 'హెచ్చరిక (Warning)',
    'abis.warning_sub': 'బ్లూమ్ పిక్సెల్స్ > 75%',
    'abis.nodata': 'తగినంత సమాచారం లేదు',
    'abis.nodata_sub': 'మేఘావృతం / ఉపగ్రహ అంతరం',
    'abis.hotspots_title': '📍 గుర్తించబడిన పర్యావరణ బ్లూమ్ హాట్‌స్పాట్లు',
    'abis.hotspot_a_title': 'a) ఈశాన్య అరేబియా సముద్రం (NEAS)',
    'abis.hotspot_a_desc': 'శీతాకాలపు పచ్చని నాక్టిలూకా బ్లూమ్‌లు, అధిక క్లోరోఫిల్ వ్యత్యాసాలు మరియు సముద్రపు ఆక్సిజన్ కొరతతో కూడుకున్నది.',
    'abis.hotspot_b_title': 'b) కేరళ తీరప్రాంత జలాలు (KRL)',
    'abis.hotspot_b_desc': 'రుతుపవనాల తీర అప్‌వెల్లింగ్ జోన్, డయాటమ్ బ్లూమ్‌లు, ఎరుపు నాక్టిలూకా మరియు చేపల ఊపిరాడక చనిపోయే ముప్పు ఉన్న ప్రాంతం.',
    'abis.hotspot_c_title': 'c) మన్నార్ గల్ఫ్ (GOM)',
    'abis.hotspot_c_desc': 'పగడపు దిబ్బల ఆరోగ్యం, సముద్ర సాగు ఆవాసాలు మరియు మైక్రో-ప్లాంక్టన్ పెరుగుదలను పర్యవేక్షించే పర్యావరణ సున్నిత బయోస్పియర్ రిజర్వ్.',
    'abis.hotspot_d_title': 'd) గోపాల్‌పూర్ తీరప్రాంత జలాలు (GPLPR)',
    'abis.hotspot_d_desc': 'నదీ పోషకాల ప్రవాహం, డయాటమ్ బ్లూమ్‌లు మరియు పెలాజిక్ మత్స్య సంపదను ట్రాక్ చేసే వాయవ్య బంగాళాఖాత తీర ప్రాంతం.',
    'abis.live_products': '📊 లైవ్ బ్లూమ్ ఉత్పత్తులు ↗',
    'abis.map_viewer': '🗺️ పెద్ద మ్యాప్ వ్యూయర్ ↗',
    'osf.svas_title': 'చిన్న నౌకల సలహా సేవ (SVAS)',
    'osf.svas_kind': 'బోట్ సేఫ్టీ ఇండెక్స్ (BSI)',
    'svas.boat_size': 'పడవ వర్గం / వెడల్పు',
    'svas.day': 'రోజు',
    'svas.day1': 'రోజు-1',
    'svas.day2': 'రోజు-2',
    'svas.day3': 'రోజు-3',
    'svas.small_craft': 'చిన్నది (< 4m)',
    'svas.small_craft_desc': 'సాంప్రదాయ పడవలు, వల్లం, కట్టుమరం, డోల్ నెట్',
    'svas.medium_craft': 'మధ్యస్థం (< 6m)',
    'svas.medium_craft_desc': 'గిల్ నెట్టర్, రింగ్ సీన్, హుక్ అండ్ లైన్',
    'svas.large_craft': 'పెద్దది (< 7m)',
    'svas.large_craft_desc': 'ట్రాలర్, పర్స్ సీనర్',
    'svas.badge_alert': 'హెచ్చరిక',
    'svas.badge_safe': 'సురక్షితం',
    'svas.banner_alert_title': '⚠️ సముద్ర ప్రయాణ ఆంక్షలు అమలులో ఉన్నాయి',
    'svas.banner_alert_sub': '{sizes} వెడల్పు గల పడవలు నిషేధిత తీర ప్రాంతాల్లోకి వెళ్లకూడదు.',
    'svas.banner_safe_title': '✅ అన్ని చిన్న పడవలకు సురక్షితం',
    'svas.banner_safe_sub': '3 రోజుల సూచన వ్యవధిలో అనుకూల సముద్ర పరిస్థితులు ఉన్నాయి.',
    'svas.safety_guidance': 'నావిగేషన్ భద్రతా సలహా:',
    'svas.guidance_unsafe': 'నిషేధించబడింది',
    'svas.guidance_safe': 'అనుమతించబడింది',
    'svas.near_me': 'నా సమీపంలో',
    'svas.locating': 'గుర్తిస్తోంది…',
    'svas.gps_failed': 'స్థానాన్ని పొందలేకపోయాము.',
    'svas.gps_unsupported': 'జియోలొకేషన్‌కు మద్దతు లేదు.',
    'svas.coastal_waters': 'తీర జలాలు',
    ...
    'footer.google_search': 'Google: India Ocean Watch ↗',
    'share.google': 'Google లో శోధించండి ↗',
  ...
  ml: {
    ...
    'osf.title': 'സമുദ്രാവസ്ഥ പ്രവചനം (OSF)',
    ...
    'dsle.title': 'ഡൈനാമിക് സീ-ലെവൽ എൻവലപ്പ് (DSLE)',
    'dsle.overtopping': 'കരകവിഞ്ഞൊഴുകൽ സാധ്യത (Crest + Hs):',
    'dsle.grounding': 'ഗ്രൗണ്ടിംഗ് സാധ്യത (Trough - Hs/2):',
    ...
    'climate.kicker': 'സമുദ്ര കാലാവസ്ഥയും പരിസ്ഥിതി നിരീക്ഷണവും',
    ...
    'other.hab': 'വിഷ പായൽ വ്യാപനം (ABIS)',
    ...
    'abis.title': '🌿 പായൽ വ്യാപന വിവര സേവനങ്ങൾ (ABIS)',
    'abis.subtitle': 'INCOIS · ഇന്ത്യൻ കടലുകളിലെ പായൽ വ്യാപനം കണ്ടെത്തലും നിരീക്ഷണവും',
    'abis.live_bulletin': 'ഏറ്റവും പുതിയ ബ്ലൂം വിവരങ്ങൾ',
    'abis.latest_run': 'അവസാനം പുതുക്കിയത്:',
    'abis.overview': 'മത്സ്യബന്ധനം, സമുദ്ര കൃഷി, സമുദ്ര ആവാസവ്യവസ്ഥ എന്നിവ സംരക്ഷിക്കുന്നതിനായി വടക്കൻ ഇന്ത്യൻ മഹാസമുദ്രത്തിൽ (0°–31°N & 35°E–103°E) ഫൈറ്റോപ്ലാങ്ക്ടൺ പായൽ വ്യാപനം തത്സമയം കണ്ടെത്താനും നിരീക്ഷിക്കാനും INCOIS ABIS സഹായിക്കുന്നു.',
    'abis.normal': 'സാധാരണം',
    'abis.normal_sub': 'പായൽ പിക്സലുകൾ < 50%',
    'abis.watch': 'നിരീക്ഷണം (Watch)',
    'abis.watch_sub': 'പായൽ പിക്സലുകൾ 50% – 75%',
    'abis.warning': 'മുന്നറിയിപ്പ് (Warning)',
    'abis.warning_sub': 'പായൽ പിക്സലുകൾ > 75%',
    'abis.nodata': 'മതിയായ വിവരമില്ല',
    'abis.nodata_sub': 'മേഘം / ഉപഗ്രഹ തടസ്സം',
    'abis.hotspots_title': '📍 തിരിച്ചറിഞ്ഞ പാരിസ്ഥിതിക പായൽ ഹോട്ട്‌സ്‌പോട്ടുകൾ',
    'abis.hotspot_a_title': 'a) വടക്കുകിഴക്കൻ അറബിക്കടൽ (NEAS)',
    'abis.hotspot_a_desc': 'ശൈത്യകാല-വസന്തകാല പച്ച നോക്റ്റിലൂക്ക പായൽ വ്യാപനം, ഉയർന്ന ക്ലോറോഫിൽ വ്യതിയാനങ്ങൾ, ഓക്സിജൻ കുറവ് എന്നിവയാൽ സവിശേഷമായത്.',
    'abis.hotspot_b_title': 'b) കേരള തീരക്കടൽ (KRL)',
    'abis.hotspot_b_desc': 'കാലവർഷ അപ്‌വെല്ലിംഗ് മേഖല, ഡയാറ്റം പായൽ, ചുവന്ന നോക്റ്റിലൂക്ക, മത്സ്യങ്ങളുടെ ശ്വാസതടസ്സം എന്നിവയ്ക്ക് സാധ്യതയുള്ള പ്രദേശം.',
    'abis.hotspot_c_title': 'c) മാന്നാർ ഉൾക്കടൽ (GOM)',
    'abis.hotspot_c_desc': 'പവിഴപ്പുറ്റുകളുടെ ആരോഗ്യം, സമുദ്ര കൃഷി ആവാസവ്യവസ്ഥകൾ, മൈക്രോ പ്ലാങ്ക്ടൺ വർദ്ധനവ് എന്നിവ നിരീക്ഷിക്കുന്ന സംരക്ഷിത മേഖല.',
    'abis.hotspot_d_title': 'd) ഗോപാൽപൂർ തീരക്കടൽ (GPLPR)',
    'abis.hotspot_d_desc': 'നദീജന്യ പോഷക പ്രവാഹം, ഡയാറ്റം പായൽ, പെലാജിക് മത്സ്യബന്ധനം എന്നിവ നിരീക്ഷിക്കുന്ന വടക്കുപടിഞ്ഞാറൻ ബംഗാൾ ഉൾക്കടൽ തീരം.',
    'abis.live_products': '📊 തത്സമയ പായൽ വിവരങ്ങൾ ↗',
    'abis.map_viewer': '🗺️ വലിയ ഭൂപടം ↗',
    'osf.svas_title': 'ചെറിയ യാനങ്ങളുടെ ഉപദേശക സേവനം (SVAS)',
    'osf.svas_kind': 'ബോട്ട് സേഫ്റ്റി ഇൻഡക്സ് (BSI)',
    'svas.boat_size': 'ബോട്ട് വിഭാഗം / വീതി',
    'svas.day': 'ദിവസം',
    'svas.day1': 'ദിവസം-1',
    'svas.day2': 'ദിവസം-2',
    'svas.day3': 'ദിവസം-3',
    'svas.small_craft': 'ചെറുത് (< 4m)',
    'svas.small_craft_desc': 'പരമ്പരാഗത വള്ളങ്ങൾ, വള്ളം, കാറ്റമരൻ, ഡോൾ നെറ്റ്',
    'svas.medium_craft': 'ഇടത്തരം (< 6m)',
    'svas.medium_craft_desc': 'ഗിൽ നെറ്റർ, റിംഗ് സീൻ, ചൂണ്ട വള്ളങ്ങൾ',
    'svas.large_craft': 'വലുത് (< 7m)',
    'svas.large_craft_desc': 'ട്രോളർ, പഴ്സ് സീനർ',
    'svas.badge_alert': 'മുന്നറിയിപ്പ്',
    'svas.badge_safe': 'സുരക്ഷിതം',
    'svas.banner_alert_title': '⚠️ കടലിൽ പോകുന്നത് നിയന്ത്രിച്ചിരിക്കുന്നു',
    'svas.banner_alert_sub': '{sizes} വീതിയുള്ള യാനങ്ങൾ നിയന്ത്രിത തീരക്കടലിലേക്ക് പോകരുത്.',
    'svas.banner_safe_title': '✅ എല്ലാ ചെറിയ യാനങ്ങൾക്കും സുരക്ഷിതം',
    'svas.banner_safe_sub': '3 ദിവസത്തെ കാലാവസ്ഥാ പ്രവചനത്തിൽ അനുകൂലമായ കടൽസാഹചര്യങ്ങൾ.',
    'svas.safety_guidance': 'സമുദ്ര സുരക്ഷാ മുന്നറിയിപ്പ്:',
    'svas.guidance_unsafe': 'വിലക്കിയിരിക്കുന്നു',
    'svas.guidance_safe': 'അനുവദിച്ചിരിക്കുന്നു',
    'svas.near_me': 'എന്റെ അടുത്ത്',
    'svas.locating': 'കണ്ടെത്തുന്നു…',
    'svas.gps_failed': 'ലൊക്കേഷൻ ലഭ്യമല്ല.',
    'svas.gps_unsupported': 'ബ്രൗസർ ലൊക്കേഷനെ പിന്തുണയ്ക്കുന്നില്ല.',
    'svas.coastal_waters': 'തീരക്കടൽ',
  ...
  bn: {
    ...
    'osf.title': 'সমুদ্রাবস্থার পূর্বাভাস (OSF)',
    ...
    'dsle.title': 'ডায়নামিক সী-লেভেল এনভেলপ (DSLE)',
    'dsle.overtopping': 'জলোচ্ছ্বাসের ঝুঁকি (Crest + Hs):',
    'dsle.grounding': 'তলদেশে ঠেকে যাওয়ার ঝুঁকি (Trough - Hs/2):',
    ...
    'climate.kicker': 'মহাসাগরীয় জলবায়ু ও বাস্তুতন্ত্র পর্যবেক্ষণ',
    ...
    'other.hab': 'ক্ষতিকারক শৈবাল (ABIS)',
    ...
    'abis.title': '🌿 শৈবাল বিস্তার তথ্য সেবা (ABIS)',
    'abis.subtitle': 'INCOIS · ভারতীয় সমুদ্রে শৈবাল বিস্তার সনাক্তকরণ ও পর্যবেক্ষণ',
    'abis.live_bulletin': 'সর্বশেষ ব্লুম তথ্য',
    'abis.latest_run': 'সর্বশেষ আপডেট:',
    'abis.overview': 'INCOIS শৈবাল বিস্তার তথ্য সেবা (ABIS) মৎস্যসম্পদ, সামুদ্রিক চাষাবাদ এবং বাস্তুতন্ত্র রক্ষার জন্য উত্তর ভারত মহাসাগরে (0°–31°N এবং 35°E–103°E) ফাইটোপ্ল্যাঙ্কটন শৈবাল প্রস্ফুটন সনাক্তকরণ ও বিস্তার পর্যবেক্ষণ সরবরাহ করে।',
    'abis.normal': 'স্বাভাবিক',
    'abis.normal_sub': 'শৈবাল পিক্সেল < ৫০%',
    'abis.watch': 'নজরদারি (Watch)',
    'abis.watch_sub': 'শৈবাল পিক্সেল ৫০% – ৭৫%',
    'abis.warning': 'সতর্কবার্তা (Warning)',
    'abis.warning_sub': 'শৈবাল পিক্সেল > ৭৫%',
    'abis.nodata': 'পর্যাপ্ত তথ্য নেই',
    'abis.nodata_sub': 'মেঘ / উপগ্রহ ব্যবধান',
    'abis.hotspots_title': '📍 চিহ্নিত পরিবেশগত শৈবাল হটস্পট',
    'abis.hotspot_a_title': 'a) উত্তর-পূর্ব আরব সাগর (NEAS)',
    'abis.hotspot_a_desc': 'শীত-বসন্তকালীন সবুজ নকটিলুকা শৈবাল বিস্তার, উচ্চ ক্লোরোফিল অস্বাভাবিকতা এবং অক্সিজেন ঘাটতি দ্বারা চিহ্নিত।',
    'abis.hotspot_b_title': 'b) কেরল উপকূলবর্তী জলসীমা (KRL)',
    'abis.hotspot_b_desc': 'মৌসুমি উপকূলীয় জলস্তর উত্তোলন অঞ্চল, ডায়াটম শৈবাল বিস্তার, লাল নকটিলুকা এবং স্থানীয় মাছের শ্বাসরোধের ঝুঁকিপূর্ণ এলাকা।',
    'abis.hotspot_c_title': 'c) মান্নার উপসাগর (GOM)',
    'abis.hotspot_c_desc': 'পরিবেশগতভাবে সংবেদনশীল বায়োস্ফিয়ার রিজার্ভ যা প্রবাল প্রাচীর স্বাস্থ্য, সামুদ্রিক বাসস্থান এবং অণুজীব বিস্তার পর্যবেক্ষণ করে।',
    'abis.hotspot_d_title': 'd) গোপালপুর উপকূলবর্তী জলসীমা (GPLPR)',
    'abis.hotspot_d_desc': 'উত্তর-পশ্চিম বঙ্গোপসাগর উপকূলীয় অঞ্চল যা নদীর পুষ্টি উপাদান নির্গমন, ডায়াটম বিস্তার এবং পেলাজিক মৎস্যসম্পদ পর্যবেক্ষণ করে।',
    'abis.live_products': '📊 লাইভ শৈবাল পণ্য ↗',
    'abis.map_viewer': '🗺️ বড় মানচিত্র প্রদর্শক ↗',
    'osf.svas_title': 'ক্ষুদ্র নৌযান পরামর্শ পরিষেবা (SVAS)',
    'osf.svas_kind': 'বোট সুরক্ষা সূচক (BSI)',
    'svas.boat_size': 'নৌকার বিভাগ / প্রস্থ',
    'svas.day': 'দিন',
    'svas.day1': 'দিন-১',
    'svas.day2': 'দিন-২',
    'svas.day3': 'দিন-৩',
    'svas.small_craft': 'ছোট (< 4m)',
    'svas.small_craft_desc': 'ঐতিহ্যবাহী নৌকা, ডিঙি, ক্যাটামারান, ডোল জাল',
    'svas.medium_craft': 'মাঝারি (< 6m)',
    'svas.medium_craft_desc': 'গিল নেটার, রিং সিন, বড়শি নৌকা',
    'svas.large_craft': 'বড় (< 7m)',
    'svas.large_craft_desc': 'ট্রলার, পার্স সিনার',
    'svas.badge_alert': 'সতর্কবার্তা',
    'svas.badge_safe': 'নিরাপদ',
    'svas.banner_alert_title': '⚠️ সমুদ্রে চলাচলে নিষেধাজ্ঞা',
    'svas.banner_alert_sub': '{sizes} প্রস্থের নৌকাগুলির সীমাবদ্ধ উপকূলীয় এলাকায় যাওয়া উচিত নয়।',
    'svas.banner_safe_title': '✅ সমস্ত ছোট নৌযানের জন্য নিরাপদ',
    'svas.banner_safe_sub': '৩ দিনের পূর্বাভাসে অনুকূল সমুদ্র পরিস্থিতি প্রত্যাশিত।',
    'svas.safety_guidance': 'নৌ চলাচল সুরক্ষা পরামর্শ:',
    'svas.guidance_unsafe': 'নিষিদ্ধ',
    'svas.guidance_safe': 'অনুমোদিত',
    'svas.near_me': 'আমার কাছাকাছি',
    'svas.locating': 'খোঁজা হচ্ছে…',
    'svas.gps_failed': 'অবস্থান পাওয়া যায়নি।',
    'svas.gps_unsupported': 'ব্রাউজার অবস্থান সমর্থন করে না।',
    'svas.coastal_waters': 'উপকূলীয় জলসীমা',
  ...
  mr: {
    ...
    'announcement.bulletin': 'बुलेटिन',
    'osf.title': 'समुद्र स्थिती अंदाज (OSF)',
    ...
    'dsle.title': 'डायनॅमिक सी-लेव्हल एनव्हेलप (DSLE)',
    'dsle.overtopping': 'किनारा ओलांडण्याचा धोका (Crest + Hs):',
    'dsle.grounding': 'तळाशी आदळण्याचा धोका (Trough - Hs/2):',
    ...
    'climate.kicker': 'सागरी हवामान आणि पर्यावरण देखरेख',
    ...
    'abis.title': '🌿 शेवाळ प्रस्फुटन माहिती सेवा (ABIS)',
    'abis.subtitle': 'INCOIS · भारतीय समुद्रातील शेवाळ प्रस्फुटन शोध व देखरेख',
    'abis.live_bulletin': 'नवीनतम ब्लूम माहिती',
    'abis.latest_run': 'शेवटचे अद्यतन:',
    'abis.overview': 'INCOIS शेवाळ प्रस्फुटन माहिती सेवा (ABIS) मत्स्यपालन, सागरी संवर्धन आणि सागरी परिसंस्थेचे रक्षण करण्यासाठी उत्तर हिंदी महासागरावर (0°–31°N आणि 35°E–103°E) फायटोप्लँक्टन शेवाळ प्रस्फुटनाचा रिअल-टाइम शोध आणि प्रसार देखरेख प्रदान करते.',
    'abis.normal': 'सामान्य',
    'abis.normal_sub': 'शेवाळ पिक्सेल < 50%',
    'abis.watch': 'दक्षता (Watch)',
    'abis.watch_sub': 'शेवाळ पिक्सेल 50% – 75%',
    'abis.warning': 'इशारा (Warning)',
    'abis.warning_sub': 'शेवाळ पिक्सेल > 75%',
    'abis.nodata': 'पुरेसा डेटा नाही',
    'abis.nodata_sub': 'ढग / उपग्रह अंतर',
    'abis.hotspots_title': '📍 ओळखलेले पर्यावरणीय प्रस्फुटन हॉटस्पॉट्स',
    'abis.hotspot_a_title': 'a) ईशान्य अरबी समुद्र (NEAS)',
    'abis.hotspot_a_desc': 'हिवाळी-वसंत ऋतूतील हिरवे नॉक्टिल्युका शेवाळ प्रस्फुटन, उच्च क्लोरोफिल विसंगती आणि ऑक्सिजनची कमतरता यासाठी ओळखले जाते.',
    'abis.hotspot_b_title': 'b) केरळ किनारपट्टीचे पाणी (KRL)',
    'abis.hotspot_b_desc': 'पावसाळी किनारपट्टी अपवेलिंग क्षेत्र जे डायटम शेवाळ, लाल नॉक्टिल्युका आणि माशांच्या श्वासोच्छवासाच्या अडचणीस संवेदनशील आहे.',
    'abis.hotspot_c_title': 'c) मन्नारचे आखात (GOM)',
    'abis.hotspot_c_desc': 'पर्यावरणीयदृष्ट्या संवेदनशील बायोस्फियर रिझर्व्ह जे प्रवाळ आरोग्य, सागरी संवर्धन अधिवास आणि सूक्ष्म-प्लँक्टन वाढीचे निरीक्षण करते.',
    'abis.hotspot_d_title': 'd) गोपाळपूर किनारपट्टीचे पाणी (GPLPR)',
    'abis.hotspot_d_desc': 'वायव्य बंगालच्या उपसागराचा किनारपट्टीचा भाग जो नदीतील पोषक घटक, डायटम शेवाळ आणि पेलाजिक मत्स्यपालनाचा मागोवा घेतो.',
    'abis.live_products': '📊 थेट प्रस्फुटन उत्पादने ↗',
    'abis.map_viewer': '🗺️ मोठा नकाशा व्ह्यूअर ↗',
    'osf.svas_title': 'लहान बोटींसाठी सल्लागार सेवा (SVAS)',
    'osf.svas_kind': 'बोट सुरक्षा निर्देशांक (BSI)',
    'svas.boat_size': 'बोट श्रेणी / रुंदी',
    'svas.day': 'दिवस',
    'svas.day1': 'दिवस-१',
    'svas.day2': 'दिवस-२',
    'svas.day3': 'दिवस-३',
    'svas.small_craft': 'लहान (< 4m)',
    'svas.small_craft_desc': 'पारंपारिक होड्या, वल्लम, कॅटामरन, डोल जाळी',
    'svas.medium_craft': 'मध्यम (< 6m)',
    'svas.medium_craft_desc': 'गिलनेटर, रिंग सीन, गळ बोटी',
    'svas.large_craft': 'मोठ्या (< 7m)',
    'svas.large_craft_desc': 'ट्रॉलर, पर्स सीनर',
    'svas.badge_alert': 'इशारा',
    'svas.badge_safe': 'सुरक्षित',
    'svas.banner_alert_title': '⚠️ नौकानयनावर निर्बंध',
    'svas.banner_alert_sub': '{sizes} रुंदीच्या बोटींनी प्रतिबंधित किनारपट्टी भागात जाऊ नये.',
    'svas.banner_safe_title': '✅ सर्व लहान बोटींसाठी सुरक्षित',
    'svas.banner_safe_sub': '३ दिवसांच्या अंदाजात अनुकूल सागरी परिस्थिती अपेक्षित आहे.',
    'svas.safety_guidance': 'सागरी सुरक्षा सल्लागार:',
    'svas.guidance_unsafe': 'प्रतिबंधित',
    'svas.guidance_safe': 'परवानगी',
    'svas.near_me': 'माझ्या जवळ',
    'svas.locating': 'शोधत आहे…',
    'svas.gps_failed': 'स्थान मिळवणे अशक्य.',
    'svas.gps_unsupported': 'स्थान समर्थित नाही.',
    'svas.coastal_waters': 'किनारपट्टीचे पाणी',
  ...
  gu: {
    ...
    'osf.title': 'દરિયાઈ સ્થિતિ આગાહી (OSF)',
    ...
    'dsle.title': 'ડાયનેમિક સી-લેવલ એન્વેલપ (DSLE)',
    'dsle.overtopping': 'ઓવરટોપિંગ જોખમ (Crest + Hs):',
    'dsle.grounding': 'ગ્રાઉન્ડિંગ જોખમ (Trough - Hs/2):',
    ...
    'climate.kicker': 'મહાસાગર આબોહવા અને ઇકોલોજી મોનિટરિંગ',
    ...
    'abis.title': '🌿 શેવાળ વૃદ્ધિ માહિતી સેવાઓ (ABIS)',
    'abis.subtitle': 'INCOIS · ભારતીય સમુદ્રમાં શેવાળ વૃદ્ધિની ઓળખ અને દેખરેખ',
    'abis.live_bulletin': 'નવીનતમ બ્લૂમ માહિતી',
    'abis.latest_run': 'છેલ્લે અપડેટ કરેલ:',
    'abis.overview': 'INCOIS શેવાળ વૃદ્ધિ માહિતી સેવાઓ (ABIS) મત્સ્યોદ્યોગ, દરિયાઈ ખેતી અને ઇકોસિસ્ટમનું રક્ષણ કરવા ઉત્તર હિંદ મહાસાગર (0°–31°N અને 35°E–103°E) પર ફાયટોપ્લાંકટોન શેવાળ ફેલાવાની રીઅલ-ટાઇમ દેખરેખ પૂરી પાડે છે.',
    'abis.normal': 'સામાન્ય',
    'abis.normal_sub': 'બ્લૂમ પિક્સેલ્સ < 50%',
    'abis.watch': 'વોચ (Watch)',
    'abis.watch_sub': 'બ્લૂમ પિક્સેલ્સ 50% – 75%',
    'abis.warning': 'ચેતવણી (Warning)',
    'abis.warning_sub': 'બ્લૂમ પિક્સેલ્સ > 75%',
    'abis.nodata': 'પૂરતો ડેટા નથી',
    'abis.nodata_sub': 'વાદળ / સેટેલાઇટ ગૅપ',
    'abis.hotspots_title': '📍 ઓળખાયેલા ઇકોલોજીકલ બ્લૂમ હોટસ્પોટ્સ',
    'abis.hotspot_a_title': 'a) ઉત્તર પૂર્વ અરબી સમુદ્ર (NEAS)',
    'abis.hotspot_a_desc': 'શિયાળુ-વસંત ઋતુમાં લીલા નોક્ટિલુકા શેવાળ વૃદ્ધિ, ઉચ્ચ ક્લોરોફિલ વિસંગતતા અને ઓક્સિજનની અછત દ્વારા વર્ગીકૃત.',
    'abis.hotspot_b_title': 'b) કેરળના દરિયાકાંઠાના વિસ્તારો (KRL)',
    'abis.hotspot_b_desc': 'ચોમાસુ દરિયાકાંઠાનું અપવેલિંગ ક્ષેત્ર, ડાયટોમ બ્લૂમ્સ, લાલ નોક્ટિલુકા અને માછલીઓના ગૂંગળામણ માટે સંવેદનશીલ.',
    'abis.hotspot_c_title': 'c) મન્નારનો અખાત (GOM)',
    'abis.hotspot_c_desc': 'પર્યાવરણીય રીતે સંવેદનશીલ બાયોસ્ફિયર રિઝર્વ જે પરવાળાના સ્વાસ્થ્ય, દરિયાઈ ખેતી અને સૂક્ષ્મ-પ્લાંકટોનની વૃદ્ધિ પર નજર રાખે છે.',
    'abis.hotspot_d_title': 'd) ગોપાલપુરના દરિયાકાંઠાના વિસ્તારો (GPLPR)',
    'abis.hotspot_d_desc': 'ઉત્તર-પશ્ચિમ બંગાળની ખાડીનો દરિયાકાંઠો જે નદીના પોષક તત્ત્વો, ડાયટોમ બ્લૂમ્સ અને પેલેજિક મત્સ્યોદ્યોગ પર નજર રાખે છે.',
    'abis.live_products': '📊 લાઈવ બ્લૂમ પ્રોડક્ટ્સ ↗',
    'abis.map_viewer': '🗺️ મોટો નકશો દર્શક ↗',
    'osf.svas_title': 'નાની બોટ સલાહકાર સેવા (SVAS)',
    'osf.svas_kind': 'બોટ સેફ્ટી ઇન્ડેક્સ (BSI)',
    'svas.boat_size': 'બોટ શ્રેણી / પહોળાઈ',
    'svas.day': 'દિવસ',
    'svas.day1': 'દિવસ-૧',
    'svas.day2': 'દિવસ-૨',
    'svas.day3': 'દિવસ-૩',
    'svas.small_craft': 'નાની (< 4m)',
    'svas.small_craft_desc': 'પરંપરાગત બોટ, વલ્લમ, કેટામરન, ડોલ નેટ',
    'svas.medium_craft': 'મધ્યમ (< 6m)',
    'svas.medium_craft_desc': 'ગિલ નેટર, રિંગ સીન, હૂક એન્ડ લાઇન',
    'svas.large_craft': 'મોટી (< 7m)',
    'svas.large_craft_desc': 'ટ્રોલર, પર્સ સીનર',
    'svas.badge_alert': 'ચેતવણી',
    'svas.badge_safe': 'સુરક્ષિત',
    'svas.banner_alert_title': '⚠️ સફર પર પ્રતિબંધ લાગુ',
    'svas.banner_alert_sub': '{sizes} પહોળાઈ ધરાવતી બોટોએ પ્રતિબંધિત દરિયાકાંઠાના વિસ્તારોમાં જવું નહીં.',
    'svas.banner_safe_title': '✅ તમામ નાની બોટો માટે સુરક્ષિત',
    'svas.banner_safe_sub': '૩-દિવસીય આગાહી વિન્ડોમાં સાનુકૂળ દરિયાઈ પરિસ્થિતિઓ.',
    'svas.safety_guidance': 'સફર સલામતી સલાહ:',
    'svas.guidance_unsafe': 'પ્રતિબંધિત',
    'svas.guidance_safe': 'પરવાનગી',
    'svas.near_me': 'મારી નજીક',
    'svas.locating': 'શોધી રહ્યું છે…',
    'svas.gps_failed': 'સ્થાન મેળવવામાં અસમર્થ.',
    'svas.gps_unsupported': 'જીઓલોકેશન સમર્થિત નથી.',
    'svas.coastal_waters': 'દરિયાકાંઠાના પાણી',
  ...
  or: {
    ...
    'osf.title': 'ସମୁଦ୍ର ଅବସ୍ଥା ପୂର୍ବାନୁମାନ (OSF)',
    ...
    'dsle.title': 'ଡାଇନାମିକ୍ ସମୁଦ୍ର ପତ୍ତନ ଏନଭେଲପ୍ (DSLE)',
    'dsle.overtopping': 'ଉଛୁଳିବା ବିପଦ (Crest + Hs):',
    'dsle.grounding': 'ଗ୍ରାଉଣ୍ଡିଂ ବିପଦ (Trough - Hs/2):',
    ...
    'climate.kicker': 'ମହାସାଗର ଜଳବାୟୁ ଏବଂ ପରିବେଶ ନିରୀକ୍ଷଣ',
    ...
    'other.hab': 'କ୍ଷତିକାରକ ଶୈବାଳ (ABIS)',
    ...
    'abis.title': '🌿 ଶୈବାଳ ବିସ୍ତାର ସୂଚନା ସେବା (ABIS)',
    'abis.subtitle': 'INCOIS · ଭାରତୀୟ ସମୁଦ୍ରରେ ଶୈବାଳ ବିସ୍ତାର ଚିହ୍ନଟ ଓ ନିରୀକ୍ଷଣ',
    'abis.live_bulletin': 'ସର୍ବଶେଷ ବ୍ଲୁମ୍ ସୂଚନା',
    'abis.latest_run': 'ଶେଷ ଅଦ୍ୟତନ:',
    'abis.overview': 'INCOIS ଶୈବାଳ ବିସ୍ତାର ସୂଚନା ସେବା (ABIS) ମତ୍ସ୍ୟ ସମ୍ପଦ, ସାମୁଦ୍ରିକ କୃଷି ଏବଂ ପରିବେଶ ସୁରକ୍ଷା ପାଇଁ ଉତ୍ତର ଭାରତ ମହାସାଗରରେ (0°–31°N ଏବଂ 35°E–103°E) ଫାଇଟୋପ୍ଲାଙ୍କଟନ୍ ଶୈବାଳ ବିସ୍ତାରର ରିଅଲ-ଟାଇମ୍ ଚିହ୍ନଟ ଓ ନିରୀକ୍ଷଣ ପ୍ରଦାନ କରେ।',
    'abis.normal': 'ସ୍ୱାଭାବିକ',
    'abis.normal_sub': 'ଶୈବାଳ ପିକ୍ସେଲ < ୫୦%',
    'abis.watch': 'ନଜର (Watch)',
    'abis.watch_sub': 'ଶୈବାଳ ପିକ୍ସେଲ ୫୦% – ୭୫%',
    'abis.warning': 'ଚେତାବନୀ (Warning)',
    'abis.warning_sub': 'ଶୈବାଳ ପିକ୍ସେଲ > ୭୫%',
    'abis.nodata': 'ପର୍ଯ୍ୟାପ୍ତ ତଥ୍ୟ ନାହିଁ',
    'abis.nodata_sub': 'ମେଘ / ଉପଗ୍ରହ ବ୍ୟବଧାନ',
    'abis.hotspots_title': '📍 ଚିହ୍ନଟ ପାରିସ୍ଥିତିକ ଶୈବାଳ ହଟସ୍ପଟ୍',
    'abis.hotspot_a_title': 'a) ଉତ୍ତର ପୂର୍ବ ଆରବ ସାଗର (NEAS)',
    'abis.hotspot_a_desc': 'ଶୀତ-ବସନ୍ତ ସବୁଜ ନୋକ୍ଟିଲୁକା ଶୈବାଳ ବିସ୍ତାର, ଉଚ୍ଚ କ୍ଲୋରୋଫିଲ୍ ଅସ୍ୱାଭାବିକତା ଏବଂ ଅମ୍ଳଜାନ ଅଭାବ ଦ୍ୱାରା ଚିହ୍ନିତ।',
    'abis.hotspot_b_title': 'b) କେରଳ ଉପକୂଳ ଜଳରାଶି (KRL)',
    'abis.hotspot_b_desc': 'ମୌସୁମୀ ଉପକୂଳ ଅପୱେଲିଂ ଅଞ୍ଚଳ ଯାହା ଡାୟାଟମ୍ ଶୈବାଳ, ଲାଲ୍ ନୋକ୍ଟିଲୁକା ଏବଂ ମାଛଙ୍କ ଶ୍ୱାସରୋଧ ପାଇଁ ସମ୍ବେଦନଶୀଳ।',
    'abis.hotspot_c_title': 'c) ମନ୍ନାର ଉପସାଗର (GOM)',
    'abis.hotspot_c_desc': 'ପାରିସ୍ଥିତିକ ସମ୍ବେଦନଶୀଳ ବାୟୋସ୍ଫିୟର ରିଜର୍ଭ ଯାହା ପ୍ରବାଳ ସ୍ୱାସ୍ଥ୍ୟ, ସାମୁଦ୍ରିକ ଆବାସସ୍ଥଳୀ ଏବଂ ସୂକ୍ଷ୍ମ-ପ୍ଲାଙ୍କଟନ୍ ବୃଦ୍ଧି ନିରୀକ୍ଷଣ କରେ।',
    'abis.hotspot_d_title': 'd) ଗୋପାଳପୁର ଉପକୂଳ ଜଳରାଶି (GPLPR)',
    'abis.hotspot_d_desc': 'ଉତ୍ତର-ପଶ୍ଚିମ ବଙ୍ଗୋପସାଗର ଉପକୂଳ ଯାହା ନଦୀର ପୋଷକ ତତ୍ତ୍ୱ ନିର୍ଗମନ, ଡାୟାଟମ୍ ଶୈବାଳ ଏବଂ ମତ୍ସ୍ୟ ସମ୍ପଦ ନିରୀକ୍ଷଣ କରେ।',
    'abis.live_products': '📊 ଲାଇଭ୍ ଶୈବାଳ ତଥ୍ୟ ↗',
    'abis.map_viewer': '🗺️ ବଡ଼ ମାନଚିତ୍ର ଦର୍ଶକ ↗',
    'osf.svas_title': 'ଛୋଟ ଡଙ୍ଗା ପରାମର୍ଶ ସେବା (SVAS)',
    'osf.svas_kind': 'ଡଙ୍ଗା ସୁରକ୍ଷା ସୂଚକାଙ୍କ (BSI)',
    'svas.boat_size': 'ଡଙ୍ଗା ବର୍ଗ / ମୋଟେଇ',
    'svas.day': 'ଦିନ',
    'svas.day1': 'ଦିନ-୧',
    'svas.day2': 'ଦିନ-୨',
    'svas.day3': 'ଦିନ-୩',
    'svas.small_craft': 'ଛୋଟ (< 4m)',
    'svas.small_craft_desc': 'ପାରମ୍ପରିକ ଡଙ୍ଗା, ବଲ୍ଲମ, କାଟାମାରାନ, ଡୋଲ ଜାଲ',
    'svas.medium_craft': 'ମଧ୍ୟମ (< 6m)',
    'svas.medium_craft_desc': 'ଗିଲ୍ ନେଟର, ରିଙ୍ଗ ସିନ୍, ବନଶୀ ଡଙ୍ଗା',
    'svas.large_craft': 'ବଡ଼ (< 7m)',
    'svas.large_craft_desc': 'ଟ୍ରଲର, ପର୍ସ ସିନର',
    'svas.badge_alert': 'ଚେତାବନୀ',
    'svas.badge_safe': 'ସୁରକ୍ଷିତ',
    'svas.banner_alert_title': '⚠️ ଯାତ୍ରା ଉପରେ କଟକଣା ଜାରି',
    'svas.banner_alert_sub': '{sizes} ମୋଟେଇ ଥିବା ଡଙ୍ଗା ନିଷିଦ୍ଧ ଉପକୂଳ ଜଳରାଶିକୁ ଯିବା ଉଚିତ୍ ନୁହେଁ।',
    'svas.banner_safe_title': '✅ ସମସ୍ତ ଛୋଟ ଡଙ୍ଗା ପାଇଁ ସୁରକ୍ଷିତ',
    'svas.banner_safe_sub': '୩-ଦିନିଆ ପୂର୍ବାନୁମାନରେ ଅନୁକୂଳ ସମୁଦ୍ର ସ୍ଥିତି।',
    'svas.safety_guidance': 'ସାମୁଦ୍ରିକ ଯାତ୍ରା ସୁରକ୍ଷା ପରାମର୍ଶ:',
    'svas.guidance_unsafe': 'ନିଷିଦ୍ଧ',
    'svas.guidance_safe': 'ଅନୁମୋଦିତ',
    'svas.near_me': 'ମୋ ପାଖରେ',
    'svas.locating': 'ଖୋଜା ଚାଲିଛି…',
    'svas.gps_failed': 'ସ୍ଥାନ ମିଳିଲା ନାହିଁ।',
    'svas.gps_unsupported': 'ଜିଓଲୋକେସନ ସମର୍ଥିତ ନୁହେଁ।',
    'svas.coastal_waters': 'ଉପକୂଳ ଜଳରାଶି',
    ...
    'footer.google_search': 'Google: India Ocean Watch ↗',
    'share.google': 'Google ରେ ସନ୍ଧାନ କରନ୍ତୁ ↗',
  ...
  kn: {
    ...
    'osf.title': 'ಸಾಗರ ಸ್ಥಿತಿ ಮುನ್ಸೂಚನೆ (OSF)',
    ...
    'dsle.title': 'ಡೈನಾಮಿಕ್ ಸಮುದ್ರ ಮಟ್ಟದ ಎನ್ವಲಪ್ (DSLE)',
    'dsle.overtopping': 'ನೀರು ನುಗ್ಗುವ ಅಪಾಯ (Crest + Hs):',
    'dsle.grounding': 'ನೆಲಕ್ಕೆ ಅಪ್ಪಳಿಸುವ ಅಪಾಯ (Trough - Hs/2):',
    ...
    'climate.kicker': 'ಸಾಗರ ಹವಾಮಾನ ಮತ್ತು ಪರಿಸರ ಮೇಲ್ವಿಚಾರಣೆ',
    ...
    'abis.title': '🌿 ಪಾಚಿ ಪ್ರಸ್ಫುಟನ ಮಾಹಿತಿ ಸೇವೆಗಳು (ABIS)',
    'abis.subtitle': 'INCOIS · ಭಾರತೀಯ ಸಮುದ್ರಗಳಲ್ಲಿ ಪಾಚಿ ಪ್ರಸ್ಫುಟನ ಪತ್ತೆ ಮತ್ತು ಮೇಲ್ವಿಚಾರಣೆ',
    'abis.live_bulletin': 'ಇತ್ತೀಚಿನ ಬ್ಲೂಮ್ ಮಾಹಿತಿ',
    'abis.latest_run': 'ಕೊನೆಯದಾಗಿ ನವೀಕರಿಸಲಾಗಿದೆ:',
    'abis.overview': 'INCOIS ಪಾಚಿ ಪ್ರಸ್ಫುಟನ ಮಾಹಿತಿ ಸೇವೆಗಳು (ABIS) ಮೀನುಗಾರಿಕೆ, ಸಾಗರ ಕೃಷಿ ಮತ್ತು ಸಮುದ್ರ ಪರಿಸರ ವ್ಯವಸ್ಥೆಗಳನ್ನು ರಕ್ಷಿಸಲು ಉತ್ತರ ಹಿಂದೂ ಮಹಾಸಾಗರದಲ್ಲಿ (0°–31°N ಮತ್ತು 35°E–103°E) ಫೈಟೊಪ್ಲ್ಯಾಂಕ್ಟನ್ ಪಾಚಿ ಪ್ರಸ್ಫುಟನವನ್ನು ನೈಜ ಸಮಯದಲ್ಲಿ ಪತ್ತೆಹಚ್ಚಿ ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡುತ್ತದೆ.',
    'abis.normal': 'ಸಾಮಾನ್ಯ',
    'abis.normal_sub': 'ಪಾಚಿ ಪಿಕ್ಸೆಲ್‌ಗಳು < 50%',
    'abis.watch': 'ವೀಕ್ಷಣೆ (Watch)',
    'abis.watch_sub': 'ಪಾಚಿ ಪಿಕ್ಸೆಲ್‌ಗಳು 50% – 75%',
    'abis.warning': 'ಎಚ್ಚರಿಕೆ (Warning)',
    'abis.warning_sub': 'ಪಾಚಿ ಪಿಕ್ಸೆಲ್‌ಗಳು > 75%',
    'abis.nodata': 'ಸಾಕಷ್ಟು ಡೇಟಾ ಇಲ್ಲ',
    'abis.nodata_sub': 'ಮೋಡ / ಉಪಗ್ರಹ ಅಂತರ',
    'abis.hotspots_title': '📍 ಗುರುತಿಸಲಾದ ಪರಿಸರ ಪಾಚಿ ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು',
    'abis.hotspot_a_title': 'a) ಈಶಾನ್ಯ ಅರಬ್ಬಿ ಸಮುದ್ರ (NEAS)',
    'abis.hotspot_a_desc': 'ಚಳಿಗಾಲ-ವಸಂತ ಋತುವಿನ ಹಸಿರು ನಾಕ್ಟಿಲುಕಾ ಪಾಚಿ ಪ್ರಸ್ಫುಟನ, ಹೆಚ್ಚಿನ ಕ್ಲೋರೊಫಿಲ್ ವೈಪರೀತ್ಯಗಳು ಮತ್ತು ಆಮ್ಲಜನಕದ ಕೊರತೆಯಿಂದ ಗುರುತಿಸಲ್ಪಟ್ಟಿದೆ.',
    'abis.hotspot_b_title': 'b) ಕೇರಳ ಕರಾವಳಿ ಜಲಪ್ರದೇಶ (KRL)',
    'abis.hotspot_b_desc': 'ಮುಂಗಾರು ಕರಾವಳಿ ಅಪ್‌ವೆಲ್ಲಿಂಗ್ ವಲಯ, ಡಯಾಟಮ್ ಪಾಚಿ, ಕೆಂಪು ನಾಕ್ಟಿಲುಕಾ ಮತ್ತು ಮೀನುಗಳ ಉಸಿರುಗಟ್ಟುವಿಕೆಗೆ ತುತ್ತಾಗುವ ಪ್ರದೇಶ.',
    'abis.hotspot_c_title': 'c) ಮನ್ನಾರ್ ಕೊಲ್ಲಿ (GOM)',
    'abis.hotspot_c_desc': 'ಹವಳದ ದಿಬ್ಬಗಳ ಆರೋಗ್ಯ, ಸಾಗರ ಕೃಷಿ ಆವಾಸಸ್ಥಾನಗಳು ಮತ್ತು ಸೂಕ್ಷ್ಮ ಪ್ಲ್ಯಾಂಕ್ಟನ್ ಹೆಚ್ಚಳವನ್ನು ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡುವ ಪರಿಸರ ಸೂಕ್ಷ್ಮ ಜೀವಗೋಳ ಮೀಸಲು ಪ್ರದೇಶ.',
    'abis.hotspot_d_title': 'd) ಗೋಪಾಲ್ಪುರ ಕರಾವಳಿ ಜಲಪ್ರದೇಶ (GPLPR)',
    'abis.hotspot_d_desc': 'ನದಿಯ ಪೋಷಕಾಂಶಗಳ ಹರಿವು, ಡಯಾಟಮ್ ಪಾಚಿ ಮತ್ತು ಪೆಲಾಜಿಕ್ ಮೀನುಗಾರಿಕೆಯನ್ನು ಪತ್ತೆಹಚ್ಚುವ ವಾಯವ್ಯ ಬಂಗಾಳ ಕೊಲ್ಲಿ ಕರಾವಳಿ ಪ್ರದೇಶ.',
    'abis.live_products': '📊 ನೇರ ಪಾಚಿ ಉತ್ಪನ್ನಗಳು ↗',
    'abis.map_viewer': '🗺️ ದೊಡ್ಡ ನಕ್ಷೆ ವೀಕ್ಷಕ ↗',
    'osf.svas_title': 'ಸಣ್ಣ ದೋಣಿಗಳ ಸಲಹಾ ಸೇವೆ (SVAS)',
    'osf.svas_kind': 'ದೋಣಿ ಸುರಕ್ಷತಾ ಸೂಚ್ಯಂಕ (BSI)',
    'svas.boat_size': 'ದೋಣಿ ವರ್ಗ / ಅಗಲ',
    'svas.day': 'ದಿನ',
    'svas.day1': 'ದಿನ-೧',
    'svas.day2': 'ದಿನ-೨',
    'svas.day3': 'ದಿನ-೩',
    'svas.small_craft': 'ಸಣ್ಣದು (< 4m)',
    'svas.small_craft_desc': 'ಸಾಂಪ್ರದಾಯಿಕ ದೋಣಿಗಳು, ವಲ್ಲಂ, ಕ್ಯಾಟಮರನ್, ಡೋಲ್ ನೆಟ್',
    'svas.medium_craft': 'ಮಧ್ಯಮ (< 6m)',
    'svas.medium_craft_desc': 'ಗಿಲ್ ನೆಟ್ಟರ್, ರಿಂಗ್ ಸೀನ್, ಗಾಳದ ದೋಣಿಗಳು',
    'svas.large_craft': 'ದೊಡ್ಡದು (< 7m)',
    'svas.large_craft_desc': 'ಟ್ರಾಲ್, ಪರ್ಸ್ ಸೀನರ್',
    'svas.badge_alert': 'ಎಚ್ಚರಿಕೆ',
    'svas.badge_safe': 'ಸುರಕ್ಷಿತ',
    'svas.banner_alert_title': '⚠️ ಸಮುದ್ರಯಾನಕ್ಕೆ ನಿರ್ಬಂಧ',
    'svas.banner_alert_sub': '{sizes} ಅಗಲದ ದೋಣಿಗಳು ನಿರ್ಬಂಧಿತ ಕರಾವಳಿ ಪ್ರದೇಶಕ್ಕೆ ಹೋಗಬಾರದು.',
    'svas.banner_safe_title': '✅ ಎಲ್ಲಾ ಸಣ್ಣ ದೋಣಿಗಳಿಗೆ ಸುರಕ್ಷಿತ',
    'svas.banner_safe_sub': '೩ ದಿನಗಳ ಮುನ್ಸೂಚನೆ ಅವಧಿಯಲ್ಲಿ ಅನುಕೂಲಕರ ಸಮುದ್ರ ಪರಿಸ್ಥಿತಿಗಳು.',
    'svas.safety_guidance': 'ಸಮುದ್ರಯಾನ ಸುರಕ್ಷತಾ ಸಲಹೆ:',
    'svas.guidance_unsafe': 'ನಿರ್ಬಂಧಿಸಲಾಗಿದೆ',
    'svas.guidance_safe': 'ಅನುಮತಿಸಲಾಗಿದೆ',
    'svas.near_me': 'ನನ್ನ ಹತ್ತಿರ',
    'svas.locating': 'ಹುಡುಕಲಾಗುತ್ತಿದೆ…',
    'svas.gps_failed': 'ಸ್ಥಳವನ್ನು ಪಡೆಯಲು ಸಾಧ್ಯವಾಗುತ್ತಿಲ್ಲ.',
    'svas.gps_unsupported': 'ಜಿಯೋಲೋಕೇಶನ್ ಬೆಂಬಲಿತವಾಗಿಲ್ಲ.',
    'svas.coastal_waters': 'ಕರಾವಳಿ ನೀರು',
    ...
    'footer.google_search': 'Google: India Ocean Watch ↗',
    'share.google': 'Google ನಲ್ಲಿ ಹುಡುಕಿ ↗',
