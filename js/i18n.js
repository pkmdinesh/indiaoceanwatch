...
const I18N_SECTORS = {
  ...
  'SOUTH ANDHRA PRADESH': { hi: 'दक्षिण आंध्र प्रदेश', ta: 'தெற்கு ஆந்திரா', te: 'దక్షిణ ఆంధ్రప్రదేశ్', ml: 'തെക്കൻ ആന്ധ്രാ പ്രദേശ്', bn: 'দক্ষিণ অন্ধ୍ର প্রদেশ', mr: 'दक्षिण आंध्र प्रदेश', gu: 'દક્ષિણ આંધ્ર પ્રદેશ', or: 'ଦକ୍ଷିଣ ଆନ୍ଧ୍ର ପ୍ରଦେଶ', kn: 'ದಕ್ಷಿಣ ಆಂಧ್ರ ಪ್ರದೇಶ' },
  'NORTH ANDHRA PRADESH': { hi: 'उत्तर आंध्र प्रदेश', ta: 'வடக்கு ஆந்திரா', te: 'ఉత్తర ఆంధ్రప్రదేశ్', ml: 'വടക്കൻ ആന്ധ്രാ പ്രദേശ്', bn: 'উত্তর অন্ধ୍ର প্রদেশ', mr: 'उत्तर आंध्र प्रदेश', gu: 'ઉત્તર આંધ્ર પ્રદેશ', or: 'ଉତ୍ତର ଆନ୍ଧ୍ର ପ୍ରଦେଶ', kn: 'ಉತ್ತರ ಆಂಧ್ರ ಪ್ರದೇಶ' },
  'ODISHA': { hi: 'ओडिशा', ta: 'ஒடிசா', te: 'ఒడిశా', ml: 'ഒഡീഷ', bn: 'ଓଡ଼ିଶା', mr: 'ओडिशा', gu: 'ઓડિશા', or: 'ଓଡ଼ିଶା', kn: 'ಒಡಿಶಾ' },
  'WEST BENGAL': { hi: 'पश्चिम बंगाल', ta: 'மேற்கு வங்கம்', te: 'పశ్ಚಿమ బెంగాల్', ml: 'പശ്ചിമ ബംഗാൾ', bn: 'পশ্চিমবঙ্গ', mr: 'पश्चिम बंगाल', gu: 'પશ્ચિમ બંગાળ', or: 'ପଶ୍ଚିମ ବଙ୍ଗ', kn: 'ಪಶ್ಚಿಮ ಬಂಗಾಳ' },
...
const I18N_DIRECTIONS = {
  ...
  'S': { hi: 'दक्षिण (S)', ta: 'தெற்கு (S)', te: 'ದక్షిణం (S)', ml: 'തെക്ക് (S)', bn: 'দক্ষিণ (S)', mr: 'दक्षिण (S)', gu: 'દક્ષિણ (S)', or: 'ଦକ୍ଷିଣ (S)', kn: 'ದಕ್ಷಿಣ (S)' },
  ...
  'NW': { hi: 'उत्तर-पश्चिम (NW)', ta: 'வடமேற்கு (NW)', te: 'వాయువ్యం (NW)', ml: 'വടക്കുപടിഞ്ഞാറ് (NW)', bn: 'উত্তর-পশ্চিম (NW)', mr: 'वायव्य (NW)', gu: 'ઉત્તર-પશ્ચિમ (NW)', or: 'ଉତ୍ତର-ପଶ୍ଚିମ (NW)', kn: 'ವಾಯುವ್ಯ (NW)' },
  'SE': { hi: 'दक्षिण-पूर्व (SE)', ta: 'தென்கிழக்கு (SE)', te: 'ఆగ్నేయం (SE)', ml: 'തെക്കുകிழക്ക് (SE)', bn: 'দক্ষিণ-পূর্ব (SE)', mr: 'आग्નેય (SE)', gu: 'દક્ષિણ-પૂર્વ (SE)', or: 'ଦକ୍ଷିଣ-ପୂର୍ବ (SE)', kn: 'ಆಗ್ನೇಯ (SE)' },
  'SW': { hi: 'दक्षिण-पश्चिम (SW)', ta: 'தென்மேற்கு (SW)', te: 'నైరుతి (SW)', ml: 'തെക്കുപടിഞ്ഞാറ് (SW)', bn: 'দক্ষিণ-পশ্চিম (SW)', mr: 'નૈઋત્ય (SW)', gu: 'દક્ષિણ-પશ્ચિમ (SW)', or: 'ଦକ୍ଷିଣ-ପଶ୍ଚିମ (SW)', kn: 'ನೈಋತ್ಯ (SW)' },
  ...
  'WNW': { hi: 'पश्चिम-उत्तर-पश्चिम (WNW)', ta: 'மேற்கு-வடமேற்கு (WNW)', te: 'పడమర-వాయువ్యం (WNW)', ml: 'പടിഞ്ഞാറ്-വടക്കുപടിഞ്ഞാറ് (WNW)', bn: 'পশ্চিম-উত্তর-পশ্চিম (WNW)', mr: 'पश्चिम-वायव्य (WNW)', gu: 'પશ્ચિમ-ઉત્તર-પશ્ચિમ (WNW)', or: 'ପଶ୍ଚିମ-ଉତ୍ତର-ପଶ୍ଚିମ (WNW)', kn: 'ಪಶ್ಚಿಮ-ವಾಯುವ್ಯ (WNW)' },
  ...
  'SSW': { hi: 'दक्षिण-दक्षिण-पश्चिम (SSW)', ta: 'தெற்கு-தென்மேற்கு (SSW)', te: 'దక్షిణ-నైరుతి (SSW)', ml: 'തെക്ക്-തെക്കുപടിഞ്ഞാറ് (SSW)', bn: 'দক্ষিণ-দক্ষিণ-পশ্চিম (SSW)', mr: 'दक्षिण-नैऋत्य (SSW)', gu: 'દક્ષિણ-દક્ષિણ-પશ્ચિમ (SSW)', or: 'ଦକ୍ଷିଣ-ଦକ୍ଷିଣ-ପଶ୍ଚିମ (SSW)', kn: 'ದಕ್ಷಿಣ-ನೈಋತ್ಯ (SSW)' }
};
...
globalThis.i18n = {
  ...
  translateAdvisoryMessage(msg) {
    ...
    if (this.currentLang === 'ta') {
      ...
      translated = translated
        .replace(/High waves in the range of ([0-9.\s-]+) meters are forecasted/gi, '$1 മീറ്റർ ഉയരത്തിൽ ഉയർന്ന തിരമാലകൾക്ക് സാധ്യതയുണ്ട്')
        .replace(/Swell waves of height ([0-9.\s-]+) meters/gi, '$1 മീറ്റർ ഉയരത്തിൽ കള്ളക്കടൽ തിരമാലകൾ')
        .replace(/Current speeds in the range of ([0-9.\s-]+) m\/sec/gi, 'പ്രവാഹ വേഗത $1 മീ/സെക്കൻഡ് വരെയാകാം')
        .replace(/Fishermen and coastal population are alerted to be cautious/gi, 'മത്സ്യതൊഴിലാളികളും തീരദേശവാസികളും ജാഗ്രത പാലിക്കണമെന്ന് മുന്നറിയിപ്പ് നൽകുന്നു')
        .replace(/along the coast of/gi, 'തീരത്ത്');
    } else if (this.currentLang === 'bn') {
      translated = translated
        .replace(/High waves in the range of ([0-9.\s-]+) meters are forecasted/gi, '$1 মিটার উচ্চতার উঁচু ঢেউ ওঠার পূর্বাভাস রয়েছে')
        .replace(/Swell waves of height ([0-9.\s-]+) meters/gi, '$1 মিটার উচ্চতার সোয়েল ঢেউ')
        .replace(/Current speeds in the range of ([0-9.\s-]+) m\/sec/gi, 'স্রোতের গতিবেগ $1 মি/সেকেন্ড পর্যন্ত হতে পারে')
        ...
        .replace(/along the coast of/gi, 'উপকূল বরাবর');
    } else if (this.currentLang === 'mr') {
      translated = translated
        .replace(/High waves in the range of ([0-9.\s-]+) meters are forecasted/gi, '$1 मीटर उंचीच्या लाटा उसळण्याचा अंदाज आहे')
        .replace(/Swell waves of height ([0-9.\s-]+) meters/gi, '$1 मीटर उंचीच्या स्वेल लाटा')
        .replace(/Current speeds in the range of ([0-9.\s-]+) m\/sec/gi, 'प्रवाहाचा वेग $1 मी/सेकंद राहण्याची शक्यता आहे')
        .replace(/Fishermen and coastal population are alerted to be cautious/gi, 'मच्छીમાર आणि किनारपट्टीवरील नागरिकांना सतर्क राहण्याचा इशारा देण्यात आला आहे')
        .replace(/along the coast of/gi, 'किनारपट्टीवर');
    } else if (this.currentLang === 'gu') {
      translated = translated
        .replace(/High waves in the range of ([0-9.\s-]+) meters are forecasted/gi, '$1 મીટર ઊંચાઈના મોજાં ઉછળવાની આગાહી છે')
        .replace(/Swell waves of height ([0-9.\s-]+) meters/gi, '$1 મીટર ઊંચાઈના સ્વેલ મોજાં')
        .replace(/Current speeds in the range of ([0-9.\s-]+) m\/sec/gi, 'પ્રવાહની ઝડપ $1 મી/સેકન્ડ રહેવાની શક્યતા છે')
        .replace(/Fishermen and coastal population are alerted to be cautious/gi, 'માછીમારો અને દરિયાકાંઠાના લોકોને સાવચેત રહેવા ચેતવણી આપવામાં આવે છે')
        .replace(/along the coast of/gi, 'કાંઠે');
    } else if (this.currentLang === 'or') {
      translated = translated
        .replace(/High waves in the range of ([0-9.\s-]+) meters are forecasted/gi, '$1 ମିଟର ଉଚ୍ଚତାର ତରଙ୍ଗ ସୃଷ୍ଟି ହେବାର ପୂର୍ବାନୁମାନ କରାଯାଇଛି')
        .replace(/Swell waves of height ([0-9.\s-]+) meters/gi, '$1 ମିଟର ଉଚ୍ଚତାର ସ୍ୱେଲ୍ ତରଙ୍ଗ')
        .replace(/Current speeds in the range of ([0-9.\s-]+) m\/sec/gi, 'ସ୍ରୋତର ବେଗ $1 ମି/ସେକେଣ୍ଡ ରହିପାରେ')
        .replace(/Fishermen and coastal population are alerted to be cautious/gi, 'ମତ୍ସ୍ୟଜୀବୀ ଏବଂ ଉପକୂଳବାସୀଙ୍କୁ ସତର୍କ ରହିବାକୁ ପରାମର୍ଶ ଦିଆଯାଇଛି')
        .replace(/along the coast of/gi, 'ଉପକୂଳରେ');
    } else if (this.currentLang === 'kn') {
      translated = translated
        .replace(/High waves in the range of ([0-9.\s-]+) meters are forecasted/gi, '$1 ಮೀಟರ್ ಎತ್ತರದ ಅಲೆಗಳು ಏಳುವ ಸಾಧ್ಯತೆಯಿದೆ')
        .replace(/Swell waves of height ([0-9.\s-]+) meters/gi, '$1 ಮೀಟರ್ ಎತ್ತರದ ಸ್ವೆಲ್ ಅಲೆಗಳು')
        .replace(/Current speeds in the range of ([0-9.\s-]+) m\/sec/gi, 'ಪ್ರವಾಹದ ವೇಗ $1 ಮೀ/ಸೆಕೆಂಡ್ ಇರಬಹುದು')
        .replace(/Fishermen and coastal population are alerted to be cautious/gi, 'ಮೀನುಗಾರರು ಮತ್ತು ಕರಾವಳಿ ಜನರು ಎಚ್ಚರಿಕೆಯಿಂದ ಇರಲು ಸೂಚಿಸಲಾಗಿದೆ')
        .replace(/along the coast of/gi, 'ಕರಾವಳಿಯುದ್ದಕ್ಕೂ');
    }
